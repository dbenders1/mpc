...
struct ConfigurationMPC
{
    ...
    std::vector<double> current_position_marker_color_, current_position_marker_scale_;
    bool draw_current_region_;
    int region_min_n_points_, current_region_n_points_, predicted_regions_n_points_;
    std::vector<double> current_region_marker_scale_;
    double current_region_marker_z_;
    int draw_predicted_positions_ground_air_;
    std::vector<double> predicted_positions_marker_color_, predicted_positions_marker_scale_;
    ...
    std::vector<double> reference_trajectory_marker_color_, reference_trajectory_marker_scale_;
    ...
    // System interface
    bool record_cur_state_, record_pred_traj_, record_slack_, record_time_reference_;
    // Modules
    ...
    std::string predicted_positions_vis_topic_, predicted_positions_ground_vis_topic_;
    std::string predicted_regions_vis_topic_;
    // Modules
    std::string goal_position_vis_topic_, goal_position_ground_vis_topic_;
    std::string reference_trajectory_vis_topic_, reference_trajectory_ground_vis_topic_;
    std::string constraints_vis_topic_;

    /* Recording */
    // System interface
    std::string cur_state_rec_topic_, pred_traj_rec_topic_, slack_rec_topic_, time_reference_rec_topic_;
    // Modules
    ...
    std::string start_mpc_layer_topic_, ref_topic_, pmpc_obj_reached_topic_, pmpc_failure_topic_;
    /************************************************************/
};
