...
/**
 * @brief This class defines the functions that are called from the controller class.
 * These should be implemented for ALL interfaces.
 * 
 */
...
public:
    ...
    /**
     * @brief Interface computations after module updates (e.g., for applying interface-specific constraint tightening)
    */
