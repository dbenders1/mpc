...
{
public:
    Controller(ros::NodeHandle& nh, ConfigurationMPC* ptr_config, SolverBase* ptr_solver, InterfaceBase* ptr_interface, ModuleHandlerBase* ptr_module_handler, DataSaverJson* ptr_data_saver_json);
    ~Controller();
    ...
    Helpers::Benchmarker optimization_benchmarker_, control_loop_benchmarker_, module_benchmarkers_;
