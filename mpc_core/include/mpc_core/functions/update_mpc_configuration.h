...
/**
 * @brief function that is called when the ros param has no default value and is not defined
 * 
...
/**
 * @brief function that prints a warning, called when ROS recordings are disabled, but the recording variable is set to true
 * 
 * @param name 
 */
