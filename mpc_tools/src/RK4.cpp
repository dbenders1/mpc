...
void Observer<StateType>::operator()(const StateType &x_cur, const double t_cur) noexcept
{
    x.push_back(x_cur);
...
void Integrator<StateType, System>::integrate_const(System& sys, StateType& x_cur, const double t_cur, const double t_final, const double dt)
{
...
//template void Observer<std::vector<double>>::operator()(const std::vector<double> &, const double);
//template void Integrator<std::vector<double>>::integrate_const(System<std::vector<double>>&, std::vector<double>, const double, const double, const double);
