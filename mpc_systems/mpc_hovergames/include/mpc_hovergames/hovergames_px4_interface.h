...
public:
    ...
    HovergamesPX4Interface(ros::NodeHandle& nh, ControllerBase *ptr_controller, ConfigurationMPC *ptr_config, SolverBase *ptr_solver, ModuleHandlerBase *ptr_module_handler, RobotRegion *ptr_robot_region, DataSaverJson *ptr_data_saver_json, std::mutex *mutex);
...
private:
    ...
    ros::Publisher attitude_pub_, position_pub_, acceleration_pub_, position_guess_pub_, time_ref_pub_;
    ros::Subscriber hover_thrust_sub_, battery_voltage_sub_, imu_sub_, time_ref_sub_;
