...
integrator_options['stepsize'] = 0.05       # Timestep of the integrator - should equal the PMPC stepsize (default: 0.05)
integrator_options['steps'] = 1             # Steps before reaching the next timestep: integration is done for a total amount of time equal to stepsize*steps (default: 1)
...
if model_options['use_terminal_set_constraint']:
    ...
    modules.add_module(control_modules.TerminalConstraintsSet(offline_comp, model_options['use_slack']), terminal_constraint_stages)
